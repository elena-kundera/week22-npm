...
document.addEventListener("DOMContentLoaded", function(event) {
    fetch("http://localhost:3001/comments").then((response)=>response.json()).then((data)=>getPosts(data));
});
btn.addEventListener("click", function(event) {
    ...
    }).then((response)=>response.json()).then((data)=>postPost(data));
...
},{}]},["a7oFG","7Jfkl"], "7Jfkl", "parcelRequirebc7a")
